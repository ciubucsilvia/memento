    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="form-group">
          {!! Form::label('category_id', $fields['category_id']) !!}
            {!! Form::select('category_id', $categories, isset($article) ? $article->category->id : null, ['class'=>"form-control"]) !!}
        </div>
      ...
      <div class="col-md-6">
        ...
        @if(isset($article->image))
          {!! Form::hidden('old_image', $article->image->min) !!}
          <div class="form-group old_image">
              {!! Form::label('img', 'Image article') !!} <br>
              {!! Html::image(asset(env('THEME')) . '/images/articles/' . $article->image->min) !!}
          </div>
        @endif
      </div>
    </div>
