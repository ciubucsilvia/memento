    ...
    <li class="comment byuser comment-author-marco even thread-even depth-1">
        ...
        <div id="comment-{{ $item->id }}" class="comment-container">
            <div class="comment-author vcard">
                ...
                <img alt="" src="https://www.gravatar.com/avatar/{{$hash}}?d=mm&s=75" class="avatar avatar-75 photo" height="75" width="75" />                <cite class="fn">{{ $item->user->name or $item->name }}</cite>             
            </div>
