    ...
    <table class="table table-hover">
      ...
      <?php $__currentLoopData = $portfolios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $portfolio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          ...
          <td><?php echo e($portfolio->category->title); ?></td>
          <td>
            <?php if(isset($portfolio->image->min)): ?>
              <?php echo Html::image(asset(config('settings.theme')) . '/images/portfolios/' . $portfolio->image->min); ?>

            <?php endif; ?>
          </td>
          <td><?php echo e($portfolio->published); ?></td>
          <td class="pull-right">
            <div class="col-md-5">
              <?php echo Html::linkRoute('portfolios.edit', $buttons['edit'], ['portfolio' => $portfolio->id], ['class' => 'btn btn-info']); ?>  
            </div>
            <div class="col-md-3">
              <?php echo Form::open([
                    'method' => 'DELETE',
