            ...
            <div class="group inner footer_row_1 footer_cols_3">
                ...
                <div class="widget widget_nav_menu">
                    ...
                    <div class="menu-footer-menu-container">
                        <ul id="menu-footer-menu" class="menu">
                            <?php $__currentLoopData = $menuBottom->roots(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($k == Config::get('settings.site')['footer_nr_pages']): ?>
                                    <?php break; ?>;
                                <?php endif; ?>
                ...
                <div class="quick-contact-widget widget two-third last">
                    <div class="widget-last widget quick-contact">
                        ...
                        <?php echo $__env->make(env('THEME') . '.site.parts.form_contact_footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <div class="right">
                    <?php if($icons): ?>
                        <?php $__currentLoopData = $icons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($icon->link); ?>" class="socials <?php echo e($icon->class); ?>" style="font-size:30px;" title="<?php echo e(str_limit($icon->title)); ?>"><?php echo e($icon->icon); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </div>
            </div>
