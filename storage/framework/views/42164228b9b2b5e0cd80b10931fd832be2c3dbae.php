    <form id="contact-form-example" class="contact-form" method="post" action="<?php echo e(route('contactStore')); ?>" enctype="multipart/form-data">
        <div class="usermessagea"></div>
        <fieldset>
            <ul>
                <li class="text-field">
                    <label for="name-example">
                    <span class="label"><?php echo e(Lang::get('site.index')['contact_form']['name']); ?></span>
                    </label>
                ...
                <li class="text-field">
                    ...
                    <span class="label"><?php echo e(Lang::get('site.index')['contact_form']['email']); ?></span>
                    </label>
                ...
                <li class="textarea-field">
                    ...
                    <span class="label"><?php echo e(Lang::get('site.index')['contact_form']['message']); ?></span>
                    </label>
                ...
                <li class="submit-button">
                    ...
                    <input type="submit" name="yiw_sendemail" value="<?php echo e(Lang::get('site.index')['contact_form']['send_msg']); ?>" class="sendmail alignright" />			
                </li>
