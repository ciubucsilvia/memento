    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="form-group">
          <?php echo Form::label('category_id', $fields['category_id']); ?>
            ...
            <?php echo Form::select('category_id', $categories, isset($portfolio) ? $portfolio->category->id : null, ['class'=>"form-control"]); ?>

        </div>

        <div class="form-group">
          <?php if(isset($portfolio) && $portfolio->published): ?>
      ...
      <div class="col-md-6">
        ...
        <?php if(isset($portfolio->image)): ?>
          <?php echo Form::hidden('old_image', $portfolio->image->min); ?>

          <div class="form-group old_image">
              <?php echo Form::label('img', 'Image portfolio'); ?> <br>
              <?php echo Html::image(asset(env('THEME')) . '/images/portfolios/' . $portfolio->image->min); ?>
