<li class="comment byuser comment-author-marco even thread-even depth-1">
    ...
    <div id="comment-<?php echo e($data['id']); ?>" class="comment-container">
        <div class="comment-author vcard">
            <img alt="" src="https://www.gravatar.com/avatar/<?php echo e($data['hash']); ?>?d=mm&s=75" class="avatar avatar-75 photo" height="75" width="75" />
            <cite class="fn"><?php echo e($data['name']); ?></cite>
        </div>
        <div class="comment-meta commentmetadata">
            <div class="intro">
                <div class="commentDate">
                    <a href="#comment-<?php echo e($data['id']); ?>">
                    </a>
                </div>
